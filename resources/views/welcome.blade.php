    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full" id="navbar-hamburger">
            <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50">
                <li>
                    <a href="/" class="block py-2 px-3 text-gray-800 bg-white hover:bg-gray-300 rounded"
                        aria-current="page">Home</a>
                </li>
                <li>
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="block py-2 px-3 text-gray-800 bg-white hover:bg-gray-300 rounded">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                            ...
                            <div class="hidden duration-700 ease-in-out {{ $index === 0 ? 'block' : '' }}"
                                ...
                                <a href="{{ route('rooms.show', $r->id) }}">
                                    ...
                                    <div
                                        ...
                                        <h2 class="text-2xl md:text-4xl text-white text-center">
                                            {{ $customTexts[$index % count($customTexts)] }}</h2>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                ...
                <div class="container mx-auto flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:w-2/3 w-full px-4">
                        ...
                        <p class="text-md text-gray-600 mb-6 text-justify">
                            RuangKominfo adalah platform digital yang dirancang untuk memudahkan proses peminjaman ruang
                            rapat di Dinas Komunikasi dan Informatika (Dinkominfo). Kami hadir untuk memberikan solusi
                            yang efisien dan terintegrasi dalam mengelola kebutuhan ruang rapat, dengan tujuan
                            menciptakan lingkungan kerja yang lebih terorganisir dan produktif. Melalui layanan kami,
                            pengguna dapat dengan mudah mencari, memesan, dan mengelola jadwal ruang rapat, serta
                            mendapatkan konfirmasi pemesanan secara real-time. RuangKominfo merupakan bagian dari upaya
                            transformasi digital di Kominfo, yang terus berinovasi untuk memberikan layanan terbaik dan
                            mendukung kolaborasi yang lebih efektif di lingkungan kerja. </p>
                    </div>
                </div>
            </section>
        ...
        <footer class="bg-white rounded-lg shadow m-4">
            <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-500 sm:text-center">© 2024 <a href="https://flowbite.com/"
                        class="hover:underline">RuangKominfo™</a>. All Rights Reserved.
                </span>
