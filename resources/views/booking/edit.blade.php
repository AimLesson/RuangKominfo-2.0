                ...
                <form action="{{ route('booking.update', $booking) }}" method="POST">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <textarea name="catatan" id="catatan" value="{{ $booking->catatan }}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                        </div>
                        <div>
                            <label for="presensi" class="block mb-2 text-sm font-medium text-gray-900">Link Presensi</label>
                            <input type="text" id="presensi" name="presensi" value="{{ $booking->presensi }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
