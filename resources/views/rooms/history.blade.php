                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                    <div id="qrcode-{{ $booking->id }}" class="cursor-pointer" onclick="showQRCode('{{ $booking->presensi }}')"></div>
                                    <script>
                            ...
                            <div id="qrCodeModal" class="hidden fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center">
                                <div class="bg-white p-4 rounded-lg shadow-lg">
                                    <div id="modal-qrcode" class="text-center"></div>
